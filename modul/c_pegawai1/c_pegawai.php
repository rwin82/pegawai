...
$aksi="modul/c_pegawai/aksi_c_pegawai.php";
...
switch($_GET[act]){
	...
	echo "<h2 class='head'>DATA CALON KARYAWAN</h2>
	<input type='text' name='input_cari' size='30'><button name='cari'  class=\"easyui-linkbutton\"data-options=\"iconCls:'icon-search'\";\>Cari</button>
